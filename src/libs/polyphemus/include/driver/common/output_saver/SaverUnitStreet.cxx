...
namespace Polyphemus
{
  ...
  */
                                            ...
                                            ClassModel& Model)
  {
    ...
    if(!Model.HasField("StreetConcentration"))
      throw string("The model does not have the array for street concentrations.");
    ...
    Nstreet = Model.D2("StreetConcentration").GetLength(1);
        ...
        for (int s = 0; s < this->Ns; s++)
          {
            ...
            for(int st = 0; st < Nstreet; st++)
              Concentration_street(st) = Model.D2("StreetConcentration")(this->species_index[s], st);
