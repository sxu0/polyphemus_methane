...
elsd30_5 = ELSdN(ens, process=True, Nskip=5, Nlearning=30, Nlearning_min=5)
elsd20_5 = ELSdN(ens, process=True, Nskip=5, Nlearning=20, Nlearning_min=5)
elsd10_5 = ELSdN(ens, process=True, Nskip=5, Nlearning=10, Nlearning_min=5)
...
for U in [0.95, 1.0, 1.05]:
    eg = ExponentiatedGradient(
        ens, extended=True, U=U, Nskip=1, Nlearning=1, learning_rate=1.0e-5
    )
