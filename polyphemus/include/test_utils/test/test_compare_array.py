...
def test_compare_array():
    ...
    assert test(
        ...
        [[1.0, 2.0], [3.0, np.NaN]],
        {
            ...
            "diff_array": m([[0.0, 0.0], [0.0, -1]], [[F, F], [F, T]]),
        },
    )

    assert test(
        a,
        [[np.PINF, 2.0], [np.NINF, 4.0]],
        {
            "negative infinity": {
                "cur": "no negative infinity",
                "ref": "has 1 negative infinity",
            },
            "positive infinity": {
                "cur": "no positive infinity",
                "ref": "has 1 positive infinity",
            },
            "diff_array": m([[-1, 0.0], [-1, 0.0]], [[T, F], [T, F]]),
        },
    )

    assert test(
        [[1.0, 2.0], [3.0, -8.0]],
        [[np.NaN, 2 * 2.0], [3.0, 5.0]],
        {
            "NaN": {"cur": "no NaN", "ref": "has 1 NaN"},
            "different sign": {
            ...
            "abs max (rtol=5.00e-02)": {"cur": 8.0, "diff": 3.0, "ref": 5.0},
            "mean (rtol=1.00e-02)": {"cur": -1.0, "diff": -5.0, "ref": 4.0},
            "diff_array": m([[-1, -2.0], [0.0, -13.0]], [[T, F], [F, F]]),
        },
    )
    ...
    assert test(
        ...
        {
            "positive infinity": {
                "cur": "has 1 positive infinity",
                "ref": "no positive infinity",
            },
            "diff_array": m([[-1, 0.0], [0.0, 0.0]], [[T, F], [F, F]]),
        },
    )
    ...
    assert test(
        ...
        {
            "NaN": {
                "cur": "1 NaN not in 'ref' (and 0 also in 'ref')",
            ...
            "diff_array": m([[-1, -1], [0.0, 0.0]], [[T, T], [F, F]]),
        },
    )
