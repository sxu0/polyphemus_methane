...
class GeneralSection(_core.GeneralSection):
    ...
    def GetCompositionSection(self):
        ...
        for i in range(self.GetNd()):
            composition.append(
                [self.GetFractionIndexBoundary(i), self.GetFractionBoundary(i)]
            )
        return composition
    ...
    def GetCompositionDiscretization():
        ...
        for c in range(_core.GeneralSection_GetNc()):
            ...
            for i in range(_core.GeneralSection_GetNdStatic(c)):
                ...
                _core.GeneralSection_CollectFractionIndexBoundaryStatic(
                    c, i, fraction_index
                )
                ...
                composition_local.append(
                    [
                        _numpy.array(fraction_index, dtype=_numpy.int),
