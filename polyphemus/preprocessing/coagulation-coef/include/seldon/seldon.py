...
class Error(_object):
    ...
    def What(self):
        return _seldon.Error_What(self)

    def CoutWhat(self):
        return _seldon.Error_CoutWhat(self)
...
class WrongArgument(Error):
    ...
    def What(self):
        return _seldon.WrongArgument_What(self)
...
class LapackError(Error):
    ...
    def What(self):
        return _seldon.LapackError_What(self)
...
class ColMajor(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColMajor_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColMajor_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColMajor_GetSecond)
...
class RowMajor(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowMajor_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowMajor_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowMajor_GetSecond)
...
class ColSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColSparse_GetSecond)
...
class RowSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowSparse_GetSecond)
...
class ColComplexSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColComplexSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColComplexSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColComplexSparse_GetSecond)
...
class RowComplexSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowComplexSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowComplexSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowComplexSparse_GetSecond)
...
class ColSymSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColSymSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColSymSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColSymSparse_GetSecond)
...
class RowSymSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowSymSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowSymSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowSymSparse_GetSecond)
...
class ColSymComplexSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColSymComplexSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColSymComplexSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColSymComplexSparse_GetSecond)
...
class RowSymComplexSparse(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowSymComplexSparse_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowSymComplexSparse_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowSymComplexSparse_GetSecond)
...
class ColSymPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColSymPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColSymPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColSymPacked_GetSecond)
...
class RowSymPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowSymPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowSymPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowSymPacked_GetSecond)
...
class ColSym(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColSym_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColSym_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColSym_GetSecond)
...
class RowSym(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowSym_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowSym_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowSym_GetSecond)
...
class ColHerm(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColHerm_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColHerm_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColHerm_GetSecond)
...
class RowHerm(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowHerm_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowHerm_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowHerm_GetSecond)
...
class ColHermPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColHermPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColHermPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColHermPacked_GetSecond)
...
class RowHermPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowHermPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowHermPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowHermPacked_GetSecond)
...
class ColUpTriang(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColUpTriang_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColUpTriang_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColUpTriang_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.ColUpTriang_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.ColUpTriang_UpLo)
...
class ColLoTriang(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColLoTriang_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColLoTriang_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColLoTriang_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.ColLoTriang_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.ColLoTriang_UpLo)
...
class RowUpTriang(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowUpTriang_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowUpTriang_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowUpTriang_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.RowUpTriang_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.RowUpTriang_UpLo)
...
class RowLoTriang(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowLoTriang_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowLoTriang_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowLoTriang_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.RowLoTriang_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.RowLoTriang_UpLo)
...
class ColUpTriangPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColUpTriangPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColUpTriangPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColUpTriangPacked_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.ColUpTriangPacked_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.ColUpTriangPacked_UpLo)
...
class ColLoTriangPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.ColLoTriangPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.ColLoTriangPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.ColLoTriangPacked_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.ColLoTriangPacked_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.ColLoTriangPacked_UpLo)
...
class RowUpTriangPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowUpTriangPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowUpTriangPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowUpTriangPacked_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.RowUpTriangPacked_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.RowUpTriangPacked_UpLo)
...
class RowLoTriangPacked(_object):
    ...
    if _newclass:
        GetFirst = staticmethod(_seldon.RowLoTriangPacked_GetFirst)
    __swig_getmethods__["GetSecond"] = lambda x: _seldon.RowLoTriangPacked_GetSecond
    if _newclass:
        GetSecond = staticmethod(_seldon.RowLoTriangPacked_GetSecond)
    __swig_getmethods__["UpLo"] = lambda x: _seldon.RowLoTriangPacked_UpLo
    if _newclass:
        UpLo = staticmethod(_seldon.RowLoTriangPacked_UpLo)
...
class IntMalloc(_object):
    ...
    def allocate(self, *args):
        return _seldon.IntMalloc_allocate(self, *args)

    def deallocate(self, *args):
        return _seldon.IntMalloc_deallocate(self, *args)

    def reallocate(self, *args):
        return _seldon.IntMalloc_reallocate(self, *args)

    def memoryset(self, *args):
        return _seldon.IntMalloc_memoryset(self, *args)

    def memorycpy(self, *args):
        return _seldon.IntMalloc_memorycpy(self, *args)
...
class BoolMalloc(_object):
    ...
    def allocate(self, *args):
        return _seldon.BoolMalloc_allocate(self, *args)

    def deallocate(self, *args):
        return _seldon.BoolMalloc_deallocate(self, *args)

    def reallocate(self, *args):
        return _seldon.BoolMalloc_reallocate(self, *args)

    def memoryset(self, *args):
        return _seldon.BoolMalloc_memoryset(self, *args)

    def memorycpy(self, *args):
        return _seldon.BoolMalloc_memorycpy(self, *args)
...
class BaseSeldonVectorInt(_object):
    ...
    def GetM(self):
        return _seldon.BaseSeldonVectorInt_GetM(self)

    def GetLength(self):
        return _seldon.BaseSeldonVectorInt_GetLength(self)

    def GetSize(self):
        return _seldon.BaseSeldonVectorInt_GetSize(self)

    def GetData(self):
        return _seldon.BaseSeldonVectorInt_GetData(self)

    def GetDataConst(self):
        return _seldon.BaseSeldonVectorInt_GetDataConst(self)

    def GetDataVoid(self):
        return _seldon.BaseSeldonVectorInt_GetDataVoid(self)

    def GetDataConstVoid(self):
        return _seldon.BaseSeldonVectorInt_GetDataConstVoid(self)
...
class BaseSeldonVectorBool(_object):
    ...
    def GetM(self):
        return _seldon.BaseSeldonVectorBool_GetM(self)

    def GetLength(self):
        return _seldon.BaseSeldonVectorBool_GetLength(self)

    def GetSize(self):
        return _seldon.BaseSeldonVectorBool_GetSize(self)

    def GetData(self):
        return _seldon.BaseSeldonVectorBool_GetData(self)

    def GetDataConst(self):
        return _seldon.BaseSeldonVectorBool_GetDataConst(self)

    def GetDataVoid(self):
        return _seldon.BaseSeldonVectorBool_GetDataVoid(self)

    def GetDataConstVoid(self):
        return _seldon.BaseSeldonVectorBool_GetDataConstVoid(self)
...
class VectorInt(BaseSeldonVectorInt):
    ...
    def Clear(self):
        return _seldon.VectorInt_Clear(self)

    def Reallocate(self, *args):
        return _seldon.VectorInt_Reallocate(self, *args)

    def Resize(self, *args):
        return _seldon.VectorInt_Resize(self, *args)

    def SetData(self, *args):
        return _seldon.VectorInt_SetData(self, *args)

    def Nullify(self):
        return _seldon.VectorInt_Nullify(self)

    def __call__(self, *args):
        return _seldon.VectorInt___call__(self, *args)

    def Copy(self, *args):
        return _seldon.VectorInt_Copy(self, *args)

    def Append(self, *args):
        return _seldon.VectorInt_Append(self, *args)

    def GetDataSize(self):
        return _seldon.VectorInt_GetDataSize(self)

    def Zero(self):
        return _seldon.VectorInt_Zero(self)

    def Fill(self):
        return _seldon.VectorInt_Fill(self)

    def FillRand(self):
        return _seldon.VectorInt_FillRand(self)

    def Print(self):
        return _seldon.VectorInt_Print(self)

    def Write(self, *args):
        return _seldon.VectorInt_Write(self, *args)

    def WriteText(self, *args):
        return _seldon.VectorInt_WriteText(self, *args)

    def Read(self, *args):
        return _seldon.VectorInt_Read(self, *args)

    def __getitem__(self, *args):
        return _seldon.VectorInt___getitem__(self, *args)

    def __setitem__(self, *args):
        return _seldon.VectorInt___setitem__(self, *args)

    def __len__(self):
        return _seldon.VectorInt___len__(self)
...
class VectorBool(BaseSeldonVectorBool):
    ...
    def Clear(self):
        return _seldon.VectorBool_Clear(self)

    def Reallocate(self, *args):
        return _seldon.VectorBool_Reallocate(self, *args)

    def Resize(self, *args):
        return _seldon.VectorBool_Resize(self, *args)

    def SetData(self, *args):
        return _seldon.VectorBool_SetData(self, *args)

    def Nullify(self):
        return _seldon.VectorBool_Nullify(self)

    def __call__(self, *args):
        return _seldon.VectorBool___call__(self, *args)

    def Copy(self, *args):
        return _seldon.VectorBool_Copy(self, *args)

    def Append(self, *args):
        return _seldon.VectorBool_Append(self, *args)

    def GetDataSize(self):
        return _seldon.VectorBool_GetDataSize(self)

    def Zero(self):
        return _seldon.VectorBool_Zero(self)

    def Fill(self):
        return _seldon.VectorBool_Fill(self)

    def FillRand(self):
        return _seldon.VectorBool_FillRand(self)

    def Print(self):
        return _seldon.VectorBool_Print(self)

    def Write(self, *args):
        return _seldon.VectorBool_Write(self, *args)

    def WriteText(self, *args):
        return _seldon.VectorBool_WriteText(self, *args)

    def Read(self, *args):
        return _seldon.VectorBool_Read(self, *args)

    def __getitem__(self, *args):
        return _seldon.VectorBool___getitem__(self, *args)

    def __setitem__(self, *args):
        return _seldon.VectorBool___setitem__(self, *args)

    def __len__(self):
        return _seldon.VectorBool___len__(self)
...
class DoubleMalloc(_object):
    ...
    def allocate(self, *args):
        return _seldon.DoubleMalloc_allocate(self, *args)

    def deallocate(self, *args):
        return _seldon.DoubleMalloc_deallocate(self, *args)

    def reallocate(self, *args):
        return _seldon.DoubleMalloc_reallocate(self, *args)

    def memoryset(self, *args):
        return _seldon.DoubleMalloc_memoryset(self, *args)

    def memorycpy(self, *args):
        return _seldon.DoubleMalloc_memorycpy(self, *args)
...
class BaseSeldonVectorDouble(_object):
    ...
    def GetM(self):
        return _seldon.BaseSeldonVectorDouble_GetM(self)

    def GetLength(self):
        return _seldon.BaseSeldonVectorDouble_GetLength(self)

    def GetSize(self):
        return _seldon.BaseSeldonVectorDouble_GetSize(self)

    def GetData(self):
        return _seldon.BaseSeldonVectorDouble_GetData(self)

    def GetDataConst(self):
        return _seldon.BaseSeldonVectorDouble_GetDataConst(self)

    def GetDataVoid(self):
        return _seldon.BaseSeldonVectorDouble_GetDataVoid(self)

    def GetDataConstVoid(self):
        return _seldon.BaseSeldonVectorDouble_GetDataConstVoid(self)
...
class VectorDouble(BaseSeldonVectorDouble):
    ...
    def Clear(self):
        return _seldon.VectorDouble_Clear(self)

    def Reallocate(self, *args):
        return _seldon.VectorDouble_Reallocate(self, *args)

    def Resize(self, *args):
        return _seldon.VectorDouble_Resize(self, *args)

    def SetData(self, *args):
        return _seldon.VectorDouble_SetData(self, *args)

    def Nullify(self):
        return _seldon.VectorDouble_Nullify(self)

    def __call__(self, *args):
        return _seldon.VectorDouble___call__(self, *args)

    def Copy(self, *args):
        return _seldon.VectorDouble_Copy(self, *args)

    def Append(self, *args):
        return _seldon.VectorDouble_Append(self, *args)

    def GetDataSize(self):
        return _seldon.VectorDouble_GetDataSize(self)

    def Zero(self):
        return _seldon.VectorDouble_Zero(self)

    def Fill(self):
        return _seldon.VectorDouble_Fill(self)

    def FillRand(self):
        return _seldon.VectorDouble_FillRand(self)

    def Print(self):
        return _seldon.VectorDouble_Print(self)

    def Write(self, *args):
        return _seldon.VectorDouble_Write(self, *args)

    def WriteText(self, *args):
        return _seldon.VectorDouble_WriteText(self, *args)

    def Read(self, *args):
        return _seldon.VectorDouble_Read(self, *args)

    def __getitem__(self, *args):
        return _seldon.VectorDouble___getitem__(self, *args)

    def __setitem__(self, *args):
        return _seldon.VectorDouble___setitem__(self, *args)

    def __len__(self):
        return _seldon.VectorDouble___len__(self)
...
class MatrixBaseInt(_object):
    ...
    def GetM(self, *args):
        return _seldon.MatrixBaseInt_GetM(self, *args)

    def GetN(self, *args):
        return _seldon.MatrixBaseInt_GetN(self, *args)

    def GetSize(self):
        return _seldon.MatrixBaseInt_GetSize(self)

    def GetData(self):
        return _seldon.MatrixBaseInt_GetData(self)

    def GetDataConst(self):
        return _seldon.MatrixBaseInt_GetDataConst(self)

    def GetDataVoid(self):
        return _seldon.MatrixBaseInt_GetDataVoid(self)

    def GetDataConstVoid(self):
        return _seldon.MatrixBaseInt_GetDataConstVoid(self)
...
class MatrixPointersInt(MatrixBaseInt):
    ...
    def Clear(self):
        return _seldon.MatrixPointersInt_Clear(self)

    def GetDataSize(self):
        return _seldon.MatrixPointersInt_GetDataSize(self)

    def Reallocate(self, *args):
        return _seldon.MatrixPointersInt_Reallocate(self, *args)

    def SetData(self, *args):
        return _seldon.MatrixPointersInt_SetData(self, *args)

    def Nullify(self):
        return _seldon.MatrixPointersInt_Nullify(self)

    def Resize(self, *args):
        return _seldon.MatrixPointersInt_Resize(self, *args)

    def __call__(self, *args):
        return _seldon.MatrixPointersInt___call__(self, *args)

    def Val(self, *args):
        return _seldon.MatrixPointersInt_Val(self, *args)

    def Copy(self, *args):
        return _seldon.MatrixPointersInt_Copy(self, *args)

    def GetLD(self):
        return _seldon.MatrixPointersInt_GetLD(self)

    def Zero(self):
        return _seldon.MatrixPointersInt_Zero(self)

    def SetIdentity(self):
        return _seldon.MatrixPointersInt_SetIdentity(self)

    def Fill(self):
        return _seldon.MatrixPointersInt_Fill(self)

    def FillRand(self):
        return _seldon.MatrixPointersInt_FillRand(self)

    def Print(self, *args):
        return _seldon.MatrixPointersInt_Print(self, *args)

    def Write(self, *args):
        return _seldon.MatrixPointersInt_Write(self, *args)

    def WriteText(self, *args):
        return _seldon.MatrixPointersInt_WriteText(self, *args)

    def Read(self, *args):
        return _seldon.MatrixPointersInt_Read(self, *args)
...
class MatrixInt(MatrixPointersInt):
    ...
    def __getitem__(self, *args):
        return _seldon.MatrixInt___getitem__(self, *args)

    def __setitem__(self, *args):
        return _seldon.MatrixInt___setitem__(self, *args)

    def __len__(self):
        return _seldon.MatrixInt___len__(self)
...
class MatrixBaseDouble(_object):
    ...
    def GetM(self, *args):
        return _seldon.MatrixBaseDouble_GetM(self, *args)

    def GetN(self, *args):
        return _seldon.MatrixBaseDouble_GetN(self, *args)

    def GetSize(self):
        return _seldon.MatrixBaseDouble_GetSize(self)

    def GetData(self):
        return _seldon.MatrixBaseDouble_GetData(self)

    def GetDataConst(self):
        return _seldon.MatrixBaseDouble_GetDataConst(self)

    def GetDataVoid(self):
        return _seldon.MatrixBaseDouble_GetDataVoid(self)

    def GetDataConstVoid(self):
        return _seldon.MatrixBaseDouble_GetDataConstVoid(self)
...
class MatrixPointersDouble(MatrixBaseDouble):
    ...
    def Clear(self):
        return _seldon.MatrixPointersDouble_Clear(self)

    def GetDataSize(self):
        return _seldon.MatrixPointersDouble_GetDataSize(self)

    def Reallocate(self, *args):
        return _seldon.MatrixPointersDouble_Reallocate(self, *args)

    def SetData(self, *args):
        return _seldon.MatrixPointersDouble_SetData(self, *args)

    def Nullify(self):
        return _seldon.MatrixPointersDouble_Nullify(self)

    def Resize(self, *args):
        return _seldon.MatrixPointersDouble_Resize(self, *args)

    def __call__(self, *args):
        return _seldon.MatrixPointersDouble___call__(self, *args)

    def Val(self, *args):
        return _seldon.MatrixPointersDouble_Val(self, *args)

    def Copy(self, *args):
        return _seldon.MatrixPointersDouble_Copy(self, *args)

    def GetLD(self):
        return _seldon.MatrixPointersDouble_GetLD(self)

    def Zero(self):
        return _seldon.MatrixPointersDouble_Zero(self)

    def SetIdentity(self):
        return _seldon.MatrixPointersDouble_SetIdentity(self)

    def Fill(self):
        return _seldon.MatrixPointersDouble_Fill(self)

    def FillRand(self):
        return _seldon.MatrixPointersDouble_FillRand(self)

    def Print(self, *args):
        return _seldon.MatrixPointersDouble_Print(self, *args)

    def Write(self, *args):
        return _seldon.MatrixPointersDouble_Write(self, *args)

    def WriteText(self, *args):
        return _seldon.MatrixPointersDouble_WriteText(self, *args)

    def Read(self, *args):
        return _seldon.MatrixPointersDouble_Read(self, *args)
...
class MatrixDouble(MatrixPointersDouble):
    ...
    def __getitem__(self, *args):
        return _seldon.MatrixDouble___getitem__(self, *args)

    def __setitem__(self, *args):
        return _seldon.MatrixDouble___setitem__(self, *args)

    def __len__(self):
        return _seldon.MatrixDouble___len__(self)
